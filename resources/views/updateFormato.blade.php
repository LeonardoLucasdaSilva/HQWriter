...
@section('content')
    ...
    <div class="container w-100 mt-3">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-7">
                ...
                <div id="canvas" class="container w-100 bordas p-3 pl-3 pr-3 mt-1 mb-1" style="height: 640px">
                </div>
                <button class="btn btn-outline-dark m-auto d-flex justify-content-center mt-1"
            ...
            <div class="col-2 mt-5" id="coladicionar" style="height: 640px">
            </div>
        </div>
    </div>
    <form action="{{route('projetos.updateFormato',$formato->id)}}" method="POST">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col">
                <button class="text-center btn-sm btn-outline-dark ml-5" type="submit">Salvar formato</button>
            </div>
        </div>
    </form>
